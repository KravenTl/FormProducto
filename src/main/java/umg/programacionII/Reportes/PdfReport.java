...
public class PdfReport {
    ...
    public void generateProductReport(List<ModelProducto> productos, String outputPath) throws DocumentException, IOException {
        /*Document es el lienzo, el documento en blanco*/Document document= new Document(PageSize.LETTER,50,50,50,50);/*Tamano del papel*/;
        /*Lo que hace es abrir un puntero en el file sistem para trabajar*/PdfWriter.getInstance(document, new FileOutputStream(outputPath));
        document.open();/*Listo para empezar a trabajar*/

        addTitle(document);/*Funcion para agregar titulo dando document como referencia*/
    ...
    private void addTitle(Document document) throws DocumentException {
        /*Parrafo*/Paragraph title = new Paragraph("Reporte de soldados caidos en septiembre", TITLE_FONT);
    ...
    private void addProductTable(Document document, List<ModelProducto> productos) throws DocumentException {
        /*Crea una tabla como en word*/PdfPTable table = new PdfPTable(6); // 4 columnas para id, descripción, origen y precio
        table.setWidthPercentage(100);/*que sea del tama;o del 100 del documento*/
